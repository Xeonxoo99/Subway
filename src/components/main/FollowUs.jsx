    ...
    return (
        <div className="w-full h-screen bg-[#f0f0f0] overflow-hidden">
            ...
            <div className="flex justify-center">
                <div className="grid grid-cols-6 gap-16 max-lg:grid-cols-5 max-lg:grid-rows-7 max-md:grid-cols-4 max-md:grid-rows-8 max-sm:grid-cols-2 max-sm:grid-rows-4">
